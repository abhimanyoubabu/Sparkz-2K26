...
export default function Register() {
  ...
  // UPI payment link
  // Includes ₹1000 amount and INR currency
  const upiLink = `upi://pay?pa=${UPI_ID}&pn=Sparkz24&am=1000&cu=INR&tn=${encodeURIComponent(
    transactionNote
  )}`;
            ...
            <section>
              ...
              <div className="mt-6">
                ...
                <p className="text-xs text-white/30 mt-2">
                  ...
                  shown after completing the payment.
                </p>
